...
var $author$project$Main$NewHand = function (a) {
	return {$: 'NewHand', a: a};
};
...
var $author$project$Card$allRanks = _List_fromArray(
	[$author$project$Card$Ace, $author$project$Card$Two, $author$project$Card$Three, $author$project$Card$Four, $author$project$Card$Five, $author$project$Card$Six, $author$project$Card$Seven, $author$project$Card$Eight, $author$project$Card$Nine, $author$project$Card$Ten, $author$project$Card$Jack, $author$project$Card$Queen, $author$project$Card$King]);
...
var $author$project$Card$newDeck = A2(
	$elm$core$List$concatMap,
	function (suit) {
		return A2(
			$elm$core$List$map,
			$author$project$Card$Card(suit),
			$author$project$Card$allRanks);
	},
	$author$project$Card$allSuits);
var $author$project$Card$randomHand = A2(
	$elm$random$Random$map,
	$elm$core$Tuple$first,
	A2($elm_community$random_extra$Random$List$choices, 5, $author$project$Card$newDeck));
...
var $author$project$Count$combinations = function (list) {
	if (!list.b) {
		...
		var x = list.a;
		var xs = list.b;
		var combs = $author$project$Count$combinations(xs);
		return _Utils_ap(
			A2(
				$elm$core$List$map,
...
var $author$project$Count$value = function (_v0) {
	var face = _v0.b;
	switch (face.$) {
		case 'Ace':
			return 1;
...
var $author$project$Count$countFifteens = function (cards) {
	return 2 * $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			function (x) {
				return $elm$core$List$sum(x) === 15;
			},
			$author$project$Count$combinations(
				A2($elm$core$List$map, $author$project$Count$value, cards))));
};
var $author$project$Count$countFlush = function (cards) {
	if (((((cards.b && cards.b.b) && cards.b.b.b) && cards.b.b.b.b) && cards.b.b.b.b.b) && (!cards.b.b.b.b.b.b)) {
		var _v1 = cards.a;
		var starterSuit = _v1.a;
		var _v2 = cards.b;
		var _v3 = _v2.a;
		var suit1 = _v3.a;
		var _v4 = _v2.b;
		...
		var _v9 = _v8.a;
		var suit4 = _v9.a;
		return (_Utils_eq(starterSuit, suit1) && (_Utils_eq(starterSuit, suit2) && (_Utils_eq(starterSuit, suit3) && _Utils_eq(starterSuit, suit4)))) ? 5 : ((_Utils_eq(suit1, suit2) && (_Utils_eq(suit2, suit3) && _Utils_eq(suit3, suit4))) ? 4 : 0);
	} else {
		return 0;
	}
};
var $author$project$Count$countNobs = function (cards) {
	if (cards.b) {
		var _v1 = cards.a;
		var starterSuit = _v1.a;
		var rest = cards.b;
		var nobs = $elm$core$List$length(
			A2(
				$elm$core$List$filter,
				function (_v2) {
					var suit = _v2.a;
					var rank = _v2.b;
					return _Utils_eq(rank, $author$project$Card$Jack) && _Utils_eq(suit, starterSuit);
				},
				rest));
		return nobs;
	} else {
...
var $author$project$Count$isPair = function (cards) {
...
var $author$project$Count$sequenceValue = function (_v0) {
	var face = _v0.b;
	switch (face.$) {
		case 'Ace':
			return 1;
...
var $author$project$Count$countPairs = function (cards) {
	var pairs = $elm$core$List$length(
		A2(
			$elm$core$List$filter,
			$author$project$Count$isPair,
			$author$project$Count$combinations(
				A2($elm$core$List$map, $author$project$Count$sequenceValue, cards))));
	return pairs * 2;
};
var $author$project$Count$isRun = function (cards) {
	if (cards.b && cards.b.b) {
		var x = cards.a;
		var _v1 = cards.b;
		var y = _v1.a;
		var xs = _v1.b;
		return _Utils_eq(x + 1, y) && $author$project$Count$isRun(
...
var $author$project$Count$countRuns = function (cards) {
	var runs = A2(
		$elm$core$List$map,
		...
		A2(
			$elm$core$List$filter,
			function (list) {
				return ($elm$core$List$length(list) > 2) && $author$project$Count$isRun(list);
			},
			$author$project$Count$combinations(
				$elm$core$List$sort(
					A2($elm$core$List$map, $author$project$Count$sequenceValue, cards)))));
	...
	var maxRuns = A2(
		$elm$core$List$filter,
		function (run) {
			return _Utils_eq(run, maxRun);
		},
		runs);
	return $elm$core$List$sum(maxRuns);
};
var $author$project$Count$count = function (cards) {
	var runs = $author$project$Count$countRuns(cards);
	var pairs = $author$project$Count$countPairs(cards);
	var nobs = $author$project$Count$countNobs(cards);
	var flush = $author$project$Count$countFlush(cards);
...
var $author$project$Card$sortCards = function (cards) {
	return A2(
		$elm$core$List$sortBy,
		function (_v0) {
			var rank = _v0.b;
			return $author$project$Card$rankOrder(rank);
		},
		cards);
};
...
var $author$project$Card$suitToString = function (suit) {
	switch (suit.$) {
		case 'Clubs':
			return 'C';
		case 'Diamonds':
...
var $author$project$Card$cardToString = function (_v0) {
	var suit = _v0.a;
	var rank = _v0.b;
	return _Utils_ap(
		$author$project$Card$rankToString(rank),
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				'cards/' + ($author$project$Card$cardToString(card) + '.svg'))
			]),
		_List_Nil);
};
			...
			_List_fromArray(
				[
					...
					A2(
						...
						$author$project$Card$sortCards(rest)))
				]));
	}
};
